...
CREATE TABLE tbl_user_backup(
    ...
    name VARCHAR2(20),
    address VARCHAR2(30),
    update_date DATE DEFAULT sysdate, -- 정보 변경시간 (기본값, INSERT 되는 시간)
...
VALUES(order_history_seq.NEXTVAL, 200, 1, 5, 50000);
INSERT INTO order_history
VALUES(order_history_seq.NEXTVAL, 200, 2, 1, 20000);
INSERT INTO order_history
VALUES(order_history_seq.NEXTVAL, 200, 3, 5, 25000);
...
INSERT INTO order_history
VALUES(order_history_seq.NEXTVAL, 202, 1, 100, 1000000);
